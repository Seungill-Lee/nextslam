...
const btnRepeat = (props) => (
    <svg width="40px" height="40px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
...
const btnClose = (props) => (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" {...props}>
        <polygon points="20.3,21.7 12,13.4 3.7,21.7 2.3,20.3 10.6,12 2.3,3.7 3.7,2.3 12,10.6 20.3,2.3 21.7,3.7 13.4,12 21.7,20.3" />
    </svg>
);


export {btnPlay, btnPause, btnPrev, btnNext, btnRepeat, btnPlaylist, btnClose};
